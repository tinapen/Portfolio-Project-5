...
<div class="relative isolate overflow-hidden bg-gray-900 h-[100vh]">
  <svg
  ...
  <div class="mt-[-50px] flex h-screen items-center justify-center">
    <div class="max-w-full flex-shrink-0 px-4 text-center lg:mx-0 lg:max-w-3xl lg:pt-8">
      <h1 class="mt-10 text-5xl font-bold tracking-tight text-white sm:text-6xl">
        Information
        <span class="text-sky-500">Technology</span> Web
        <span class="text-sky-500">Development</span>
      </h1>
      <p class="mt-6 text-lg leading-8 text-gray-300">Let's work together and  collaborate!</p>
