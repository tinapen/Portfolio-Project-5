...
if (isset($_POST['submit'])) {
  ...
  if (empty($nameErr) && empty($emailErr) && empty($messageErr)) {
    ...
    $sql = "INSERT INTO feedbacktable (name, email, message, date) VALUES ('$name', '$email', '$message', '$currentDate')";
    ...
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                ...
                <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">Feel free to get in touch for any questions or assistance!
                </p>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                        ...
                        By working closely with our clients, we deliver tailored solutions that drive success.
                        Let’s partner to bring your vision to life—reach out and let's create something great together!"
                    </p>
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">San Roque, San Rafael</p>
                                <p class="text-gray-600 dark:text-slate-400">Bulacan, PH</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                        ...
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Business
                                    hours</h3>
